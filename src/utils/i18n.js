...
import it from '@/utils/i18n/it.json'
...
export function T (key, params, num = 0) {
  ...
  // fall back to English before giving up, so a key that is missing from a
  // translation shows readable text instead of the raw key
